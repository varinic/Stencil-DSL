    ...
    */
    ...
    void _target_mpi(std::string name_file, std::string target){
      ...
      if(target == "x86"){
        ...
        std::string command_run = std::string("bsub -q ")+job_queue+"-b -cgsp 64 -n "+ std::to_string(num_processes) + " -host_stack 128 -share_size 2048 " + "-o ./" + name_file + ".out " + "./" + name_file;
        ...
        std::string command_run = std::string("bsub -q ")+job_queue+"-I -b -cgsp 64 -n "+ std::to_string(num_processes) + " -host_stack 128 -share_size 2048 " + "-o ./" + name_file + ".out " + "./" + name_file;
