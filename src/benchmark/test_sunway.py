...
def test_sunway(target, bench_flag="bench_sunway", datatype="f64"):
    shape_grid_3d=[[1,1,1]]
    ...
    if (target == "sunway" and bench_flag == "bench_sunway"):
        ...
        bench_sunway("bench_sunway", "dsl_vs_openacc", target, num_threads, shape_grid_3d, shape_sub_grid_3d,\
                tile_size_xyz, shape_grid_2d, shape_sub_grid_2d, tile_size_xy, use_schedule, is_assigned, ".not_assigned"+"."+datatype)
        #
...
def test_auto_tuning(target):
    if(target=="sunway"):
        #
        shape_grid_3d=[[2,4,16],[4,8,4],[8,8,2]]
        shape_sub_grid_3d = [[4096,32,8],[2048,16,32],[1024,16,64]]
        tile_size_xyz = [[1,4,4],[1,2,8],[1,2,8]]
        shape_grid_2d=[]
        shape_sub_grid_2d = []
        tile_size_xy = []
        num_threads = [[64],[64],[64]]
        #
        use_schedule=1
        is_assigned=0
        #
        bench_sunway("bench_sunway", "test_auto_tuning", target, num_threads, shape_grid_3d, shape_sub_grid_3d,\
                tile_size_xyz, shape_grid_2d, shape_sub_grid_2d, tile_size_xy, use_schedule, is_assigned, ".not_assigned"+"."+"f64")
...
def main():
    ...
    target="sunway"
    #test_sunway(target,datatype="f64")
    #test_sunway(target,bench_flag = "seq_code",datatype="f64")
    test_sunway(target,datatype="f32")
    #test_sunway(target,bench_flag = "seq_code",datatype="f32")
    #test_auto_tuning(target)
    #
